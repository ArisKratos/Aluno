        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            aliasBtnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    //  Intent intent = new Intent(AlunoActivity.this,  AlunoConfirmadoActivity.class);

                    String ano = aliasAnoTurma.getText().toString();
                    Integer semestre = numeroSemestre;

                    carregarListConfirmada();
                }

                private void carregarListConfirmada() {

                    ArrayAdapter<Curso> adaptador = new ArrayAdapter<>(getBaseContext(), android.R.layout.simple_list_item_1, cursosConf);
                    aliasListCursoAdd.setAdapter(adaptador);
            ...
            aliasBtnSalvarCursos.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        if (aliasAnoTurma.getText().length() == 0) {
                            aliasAnoTurma.setError("Precisa inserir \n o ano de ingresso\n da turma");


                        } else {

                            aliasAnoTurmaNumero = Integer.parseInt(aliasAnoTurma.getText().toString());
                            if (aliasAnoTurmaNumero < 2000|| aliasAnoTurmaNumero > 2100) {
                                aliasAnoTurma.setError("Ano inválido");
                            } else {

                                Toast.makeText(getApplicationContext(), "Grade enviada com sucesso para: \n"+"Semestre: " + numeroSemestre + "\nCurso: " + nomeCurso + "\nAno: " + aliasAnoTurmaNumero, Toast.LENGTH_SHORT).show();
                            }
                        }
                    }catch (Exception e){
                        e.printStackTrace();
            ...
            //  aliasSpinnerSemestre.setAdapter(spinnerSemestres);
